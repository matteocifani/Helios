...
def check_client_interactions(codice_cliente: str) -> Dict[str, bool]:
    ...
    try:
        ...
        # Note: polizze table also uses integer codice_cliente
        try:
        ...
        # Note: sinistri table uses integer codice_cliente, need to convert
        try:
...
def insert_phone_call_interaction(
    ...
    try:
        ...
        # onConflict parameter specifies which column to check for conflicts
        response = _retry_query(
